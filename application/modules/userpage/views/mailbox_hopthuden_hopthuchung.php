...
?>
<div class="hopthuden_hopthuchung">
	<div class="control_tab">
		<div class="block_1">
			<a class="current" href="<?php echo base_url().'userpage/hopthuden_hopthuchung' ?>">Hộp thư chung</a>
			<a href="<?php echo base_url().'userpage/hopthuden_thubaogia' ?>">Thư báo giá</a>
			<a href="<?php echo base_url().'userpage/hopthuden_thuyeucaubaogia' ?>">Thư yêu cầu báo giá</a>
		</div>
		<div class="block_2">
			<p>1 - 5/5</p>
			<a class="next"></a>
