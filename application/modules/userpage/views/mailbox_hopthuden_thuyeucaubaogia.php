...
?>
<div class="hopthuden_thuyeucaubaogia">
	<div class="control_tab">
		<div class="block_1">
			<a href="<?php echo base_url().'userpage/hopthuden_hopthuchung' ?>">Hộp thư chung</a>
			<a href="<?php echo base_url().'userpage/hopthuden_thubaogia' ?>">Thư báo giá</a>
			<a class="current" href="<?php echo base_url().'userpage/hopthuden_thuyeucaubaogia' ?>">Thư yêu cầu báo giá</a>
		</div>
		<div class="block_2">
