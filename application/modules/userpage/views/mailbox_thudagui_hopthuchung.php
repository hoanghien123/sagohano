...
?>
<div class="thudagui_hopthuchung">
	<div class="control_tab">
		<div class="block_1">
			<a class="current" href="<?php echo base_url().'userpage/thudagui_hopthuchung' ?>">Hộp thư chung</a>
			<a href="<?php echo base_url().'userpage/thudagui_thubaogia' ?>">Báo giá đã gửi</a>
			<a href="<?php echo base_url().'userpage/thudagui_thuyeucaubaogia' ?>">Yêu cầu báo giá đã gửi</a>
		</div>
		<div class="block_2">
			<p>1 - 5/5</p>
			<a class="next"></a>
	...
	<div class="tools">
		...
		<table>
			<tr>
				<th colspan='5'><input type='checkbox' /><a class="capnhat"></a></th>
			</tr>
			<tr>
				<td>Báo giá hóa chất Chloramphenocol GMP ...</td>
				<td>Số lượng :40.000 hộp</td>
				<td><img src='public/site/images/img_nhacungcap.PNG'/><p>Phương Mai</p></td>
