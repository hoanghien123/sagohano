...
?>
<div class="thudagui_thubaogia">
	<div class="control_tab">
		<div class="block_1">
			<a href="<?php echo base_url().'userpage/thudagui_hopthuchung' ?>">Hộp thư chung</a>
			<a class="current" href="<?php echo base_url().'userpage/thudagui_thubaogia' ?>">Báo giá đã gửi</a>
