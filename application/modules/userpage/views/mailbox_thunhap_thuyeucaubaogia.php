...
?>
<div class="thunhap_thuyeucaubaogia">
	<div class="control_tab">
		<div class="block_1">
			<a href="<?php echo base_url().'userpage/thunhap_hopthuchung' ?>">Hộp thư chung</a>
			<a href="<?php echo base_url().'userpage/thunhap_thubaogia' ?>">Báo giá</a>
			<a class="current" href="<?php echo base_url().'userpage/thunhap_thuyeucaubaogia' ?>">Yêu cầu báo giá</a>
		</div>
		<div class="block_2">
