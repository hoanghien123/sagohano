...
?>
<div class="thuspam_hopthuchung">
	<div class="control_tab">
		<div class="block_1">
			<a class="current" href="<?php echo base_url().'userpage/thuspam_hopthuchung' ?>">Spam</a>
		</div>
		<div class="block_2">
			<p>1 - 5/5</p>
			<a class="next"></a>
	...
	<div class="tools">
		<div class="block_1">
			...
			<li><a class="xoavinhvien">Xóa vĩnh viễn</a></li>
			<li><a class="khongphaispam">Không phải spam</a></li>
			<li><a class="more">...</a>
				<ul>
