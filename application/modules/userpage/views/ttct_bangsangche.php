<style>
	...
	.thongtincoban_box .title_box2 a span.bangsangche{line-height: 38px;font-weight: bold;color: #cc6600}
				...
				<div class='thongtincoban_box'>
					...
					<div class='content_box2'>
						<div class='danhsachchungnhan'>
							<div class='title'><b>Danh sách bằng sáng chế:</b> <?php echo count($data_bangsangche);?></div>
							<table class='chungnhan'>
								<tr>
									<th>Mã số bằng sáng chế</th>
									<th>Tên</th>
									<th>Loại</th>
									<th>Ngày cấp</th>
								</tr>
								<?php 
									foreach ($data_bangsangche as $row) {
										$data_tenchungnhan = $this->db->query("select * from gianhang_loaibangsangche where ID=$row->LoaibangsangcheID")->row();
										$tenchungnhan = count($data_tenchungnhan) > 0 ? $data_tenchungnhan->Title : "";
										
										echo "
										<tr>
										<td>$row->Masobangsangche</td>
										<td>$row->Tenbangsangche</td>
										<td>$tenchungnhan</td>
										<td>$row->Ngaycap</td>
										</tr>
										";
						...
						<form action="<?php echo base_url() ?>userpage/add_bangsangche/<?php echo $this->shop->ID;?>" method="post" id='thongtincoban' enctype="multipart/form-data">
						<div class='themchungnhan_chungchi'>
							<div class='title'>Thêm bằng sáng chế:</div>

							<div class='content'>

								<div class='row'>
									<div class='left_row'><span>Mã số bằng sáng chế:</span></div>
									<div class='right_row'>
								...
								<div class='row'>
									<div class='left_row'><span>Tên:</span></div>
									<div class='right_row'>
								...
								<div class='row'>
									<div class='left_row'><span>Loại bằng sáng chế:</span></div>
									<div class='right_row'>
										<select name='tenchungnhan' class='tenchungnhan'>
											<option>Chọn 1</option>
											<?php 
											$dataChungnhan = $this->db->query("select * from gianhang_loaibangsangche")->result();
