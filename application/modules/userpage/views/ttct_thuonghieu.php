<style>
	...
	.thongtincoban_box .title_box2 a span.thuonghieu{line-height: 38px;font-weight: bold;color: #cc6600}
</style>
<?php
				...
				<div class='thongtincoban_box'>
					...
					<div class='content_box2'>
						<div class='danhsachchungnhan'>
							<div class='title'><b>Danh sách thương hiệu:</b> <?php echo count($data_thuonghieu);?></div>
							<table class='chungnhan'>
								...
								<?php 
									foreach ($data_thuonghieu as $row) {
										echo "
										<tr>
										<td>$row->Sodangky</td>
						...
						<form action="<?php echo base_url() ?>userpage/add_thuonghieu/<?php echo $this->shop->ID;?>" method="post" id='thongtincoban' enctype="multipart/form-data">
						<div class='themchungnhan_chungchi'>
							...
							<div class='content'>
								...
								<div class='row'>
									<div class='left_row'><span>Số đăng ký:</span></div>
									<div class='right_row'>
								...
								<div class='row'>
									<div class='left_row'><span>Tên thương hiệu:</span></div>
									<div class='right_row'>
										<input type='text' name='tenthuonghieu' class='duoccapboi'>
									</div>
								</div>
								...
								<div class='row'>
									<span class='tomtat1' style='font-weight:bold'>
										Tóm tắt sản phẩm đã đăng ký độc quyền thương hiệu:
									</span>
								</div>
